...
public class DataController extends BaseController<Data, Long, DataService> {
    ...
    // 分批插入
    @RequestMapping("/insert-batch-mock")
    ...
    // 分批更新
    @RequestMapping("/update-batch-mock")
    ...
    // 分批插入或更新
    @RequestMapping("/upsert-batch-mock")
